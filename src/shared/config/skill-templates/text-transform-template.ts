...
export const textTransformTemplate: SkillTemplate = {
  ...
  nodes: [
    { id: "t1", type: "trigger", position: { x: 60, y: 200 }, data: { label: "텍스트 입력 감지", triggers: [{ kind: "context", value: "텍스트를 변환해줘", matchMode: "fuzzy" }] } },
    {
      id: "l1",
      type: "llm",
    ...
    { id: "o1", type: "output", position: { x: 580, y: 200 }, data: { label: "변환 결과", format: "markdown", template: "{{transformed}}", streamToUser: true } },
  ],
  edges: [
